/**
 * File:  CustomIdentityStoreJPAHelper.java Course materials (22F) CST 8277
 * 
 * @author Teddy Yap
 * @author Mike Norman
 * 
...
public class CustomIdentityStoreJPAHelper {
    ...
    public SecurityUser findUserByName(String username) {
         ...
         */
        try {
            user = (SecurityUser) em.createNamedQuery("SecurityUser.userByName").setParameter("param1", username).getSingleResult();
