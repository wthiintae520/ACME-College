...
public class StudentResource {
    ...
    /**
     * A user with either the role ‘ADMIN_ROLE’ or ‘USER_ROLE’ can get a specific student. However,
     * there is logic inside the getStudentById method that disallows a ‘USER_ROLE’ user
    ...
    public Response deleteStudentById(@PathParam(RESOURCE_PATH_ID_ELEMENT) int id) {
    	...
    	response = Response.ok("Student ID: " + id + " Deleted").build();
      	return response;
    }
}
