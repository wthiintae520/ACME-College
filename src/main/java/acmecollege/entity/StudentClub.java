/***************************************************************************
 * File:  StudentClub.java Course materials (22F) CST 8277
 * 
 * @author Teddy Yap
...
//Refer to https://leoniedermeier.github.io/docs/java/snippets/java_misc/jackson_polymorphic.html
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "@type")
@JsonSubTypes({ @JsonSubTypes.Type(value = AcademicStudentClub.class, name = "academicStudentClub"), @JsonSubTypes.Type(value = NonAcademicStudentClub.class, name = "nonAcademicStudentClub"), })
public abstract class StudentClub extends PojoBase implements Serializable {
	private static final long serialVersionUID = 1L;

    public static final String ALL_STUDENT_CLUBS_QUERY_NAME = "StudentClub.findFAll";
